...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asn1-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6632&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asn1-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asn1` can be installed with:

```
conda install asn1
```

It is possible to list all of the versions of `asn1` available on your platform with:
